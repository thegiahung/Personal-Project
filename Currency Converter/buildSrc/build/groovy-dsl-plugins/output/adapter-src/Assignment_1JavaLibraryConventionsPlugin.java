...
/**
 * Precompiled Assignment_1.java-library-conventions script plugin.
 **/
public class Assignment_1JavaLibraryConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_Assignment_1JavaLibraryConventions").asSubclass(BasicScript.class);
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_Assignment_1JavaLibraryConventions").asSubclass(BasicScript.class);
