...
/**
 * Precompiled Assignment_1.java-common-conventions script plugin.
 **/
public class Assignment_1JavaCommonConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_Assignment_1JavaCommonConventions").asSubclass(BasicScript.class);
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_Assignment_1JavaCommonConventions").asSubclass(BasicScript.class);
