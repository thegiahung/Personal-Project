...
/**
 * Precompiled Assignment_1.java-application-conventions script plugin.
 **/
public class Assignment_1JavaApplicationConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_Assignment_1JavaApplicationConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("Assignment_1.java-common-conventions");
            target.getPluginManager().apply("application");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_Assignment_1JavaApplicationConventions").asSubclass(BasicScript.class);
